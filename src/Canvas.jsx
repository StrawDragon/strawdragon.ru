...
import { DUMMY_OBSTACLES } from "./constants/map";
...
export default class Canvas extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            obstacles: DUMMY_OBSTACLES.map(item => item),
            cameFrom: {},
            hexPathMap: [],
            path: [],
            hexSides: [],
    ...
    componentDidMount() {
        ...
        this.canvasWrapper = document.querySelector('div');
    ...
    handleMouseMove(e) {
      ...
      const { left: leftOffset, top: topOffset } = this.getCanvasWrappperOffset(this.canvasWrapper);
        let offsetX = e.pageX + leftOffset - left;
        let offsetY = e.pageY + topOffset - top;
        const {
            q,
            r,
            s
